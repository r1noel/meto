...
namespace dxe {
	...
	//----------------------------------------------------------------------------------------
	void Mesh::loadMaterial(const std::string& file_path) {
		FILE* fp = nullptr;
	...
	//----------------------------------------------------------------------------------------
	void Mesh::saveMaterial(const std::string& file_path) {
		FILE *fp = nullptr;
	...
	void Mesh::render(const Shared<dxe::Camera> camera) {
		...
		//ID3D11DeviceContext* con = (ID3D11DeviceContext*)DxLib::GetUseDirect3D11DeviceContext();
		//con->DrawInstanced();
	...
	//----------------------------------------------------------------------------------------
	void Mesh::drawGuiMaterialControlloer() {
		if (!mtrl_gui_ctrler_) {
